  ...
  "<span class="hljs-attribute">data</span>": <span class="hljs-value">[
    {
      ...
      "<span class="hljs-attribute">ein</span>": <span class="hljs-value"><span class="hljs-string">"0012343"</span></span>,
      "<span class="hljs-attribute">name</span>": <span class="hljs-value"><span class="hljs-string">"Chicago Art House"</span></span>,
      "<span class="hljs-attribute">city</span>": <span class="hljs-value"><span class="hljs-string">"Chicago"</span></span>,
      "<span class="hljs-attribute">state</span>": <span class="hljs-value"><span class="hljs-string">"IL"</span></span>,
      "<span class="hljs-attribute">deductibility_status_code</span>": <span class="hljs-value">[
        <span class="hljs-string">"PE"</span>,
        <span class="hljs-string">"SOUNK"</span>
      ]
    </span>}
  ]
...
</span>}</code></pre><div style="height: 1px;"></div></div></div></div></div><div id="nonprofits-validate-an-ein-value" class="resource"><h3 class="resource-heading">Validate an EIN value <a href="#nonprofits-validate-an-ein-value" class="permalink">&nbsp;&para;</a></h3><div id="nonprofits-validate-an-ein-value-get" class="action get"><h4 class="action-heading"><div class="name">Validate an EIN value</div><a href="#nonprofits-validate-an-ein-value-get" class="method get">GET</a><code class="uri">/api/nonprofits/validate/ein{?q}</code></h4><p>Validates an EIN input to see if it corresponds to a nonprofit</p>
<h4>Example URI</h4><div class="definition"><span class="method get">GET</span>&nbsp;<span class="uri"><span class="hostname"></span>/api/nonprofits/validate/ein?<span class="hljs-attribute">q=</span><span class="hljs-literal"></span></span></div><div class="title"><strong>URI Parameters</strong><div class="collapse-button show"><span class="close">Hide</span><span class="open">Show</span></div></div><div class="collapse-content"><dl class="inner"><dt>q</dt><dd><code>string</code>&nbsp;<span class="required">(required)</span>&nbsp;<p>Query for the EIN input</p>
</dd></dl></div><div class="title"><strong>Response&nbsp;&nbsp;<code>200</code></strong><div class="collapse-button"><span class="close">Hide</span><span class="open">Show</span></div></div><div class="collapse-content"><div class="inner"><h5>Headers</h5><pre><code><span class="hljs-attribute">Content-Type</span>: <span class="hljs-string">application/json</span></code></pre><div style="height: 1px;"></div><h5>Body</h5><pre><code>{
  "<span class="hljs-attribute">data</span>": <span class="hljs-value">{
    "<span class="hljs-attribute">valid</span>": <span class="hljs-value"><span class="hljs-literal">true</span>
  </span>}
</span>}</code></pre><div style="height: 1px;"></div><h5>Schema</h5><pre><code>{
  "<span class="hljs-attribute">$schema</span>": <span class="hljs-value"><span class="hljs-string">"http://json-schema.org/draft-04/schema#"</span></span>,
  "<span class="hljs-attribute">type</span>": <span class="hljs-value"><span class="hljs-string">"object"</span></span>,
  "<span class="hljs-attribute">properties</span>": <span class="hljs-value">{
    "<span class="hljs-attribute">data</span>": <span class="hljs-value">{
      "<span class="hljs-attribute">type</span>": <span class="hljs-value"><span class="hljs-string">"object"</span></span>,
      "<span class="hljs-attribute">properties</span>": <span class="hljs-value">{
        "<span class="hljs-attribute">valid</span>": <span class="hljs-value">{
          "<span class="hljs-attribute">type</span>": <span class="hljs-value"><span class="hljs-string">"boolean"</span>
        </span>}
      </span>}
    </span>}
  </span>}
</span>}</code></pre><div style="height: 1px;"></div></div></div></div></div></section></div></div></div><p style="text-align: center;" class="text-muted">Generated by&nbsp;<a href="https://github.com/danielgtaylor/aglio" class="aglio">aglio</a>&nbsp;on 18 Oct 2016</p><script>/* eslint-env browser */
